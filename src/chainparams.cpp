...
{
    const char* pszTimestamp = "2019-04-17 19:22:50, Made qtum more soft, pf->Yao()";
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000013801380"); // qtum
...
//		do{
//			genesis = CreateGenesisBlock(1555500170, nonce, 0x1f00ffff, 1, 50 * COIN);
//			consensus.hashGenesisBlock = genesis.GetHash();
//			nonce++;
